...
static struct ccu_nkmp pll_periph0_4x_clk = {
	...
	.common		= {
		.reg		= 0x020,
		.hw.init	= CLK_HW_INIT("pll-periph0-4x", "osc24M",
					      &ccu_nkmp_ops,
					      CLK_SET_RATE_UNGATE),
	},
};
...
static struct ccu_nkmp pll_periph1_4x_clk = {
	.enable		= BIT(31),
	.lock		= BIT(28),
	.n		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.m		= _SUNXI_CCU_DIV(1, 1), /* input divider */
	...
	.common		= {
		.reg		= 0x028,
		.hw.init	= CLK_HW_INIT("pll-periph1-4x", "osc24M",
					      &ccu_nkmp_ops,
					      CLK_SET_RATE_UNGATE),
	},
};
...
static struct ccu_nm pll_video1_4x_clk = {
	...
	.common		= {
		.reg		= 0x048,
		.hw.init	= CLK_HW_INIT("pll-video1-4x", "osc24M",
					      &ccu_nm_ops,
					      CLK_SET_RATE_UNGATE),
	},
};
...
static CLK_FIXED_FACTOR(pll_periph0_clk, "pll-periph0",
			"pll-periph0-4x", 4, 1, 0);
static CLK_FIXED_FACTOR(pll_periph0_2x_clk, "pll-periph0-2x",
			"pll-periph0-4x", 2, 1, 0);

static CLK_FIXED_FACTOR(pll_periph1_clk, "pll-periph1",
			"pll-periph1-4x", 4, 1, 0);
static CLK_FIXED_FACTOR(pll_periph1_2x_clk, "pll-periph1-2x",
			"pll-periph1-4x", 2, 1, 0);

static CLK_FIXED_FACTOR(pll_video0_clk, "pll-video0",
			"pll-video0-4x", 4, 1, CLK_SET_RATE_PARENT);

static CLK_FIXED_FACTOR(pll_video1_clk, "pll-video1",
